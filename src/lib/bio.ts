export const bio = {
  ...
  taste: `The shelves make the same argument the resume does. Graham and Munger sit on the desk with Holiday and Hamming — temperament, a daily page, and the engineering of learning. Harari, Kahneman, and Cathy O’Neil hold the tall bay. The O’Reilly pile is the night school: Chip Huyen on agents, Yves Hilpisch on markets in Python. Willink, Dalio, and Collins are how a Team Lead at BDO Digital thinks about giving the keys back.`,
  quote:
